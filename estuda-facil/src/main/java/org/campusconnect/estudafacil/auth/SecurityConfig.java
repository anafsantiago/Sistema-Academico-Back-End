        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> {
                    authorize
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/turma/carregar-turmas-alocaveis").permitAll()
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/discente/carregar-discente-cpf").permitAll()
                            .requestMatchers(HttpMethod.POST, "/api/alocacao-discente/cadastrar").permitAll()
